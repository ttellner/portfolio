...
base_dir = Path(__file__).parent / "gnnprojects"
project_file = st.query_params.get("project")

if project_file:
    project_path = base_dir / project_file
    init_hub_page(
        index_title="Graph Neural Networks",
        project_title=title_from_file(project_path, "GNN Project"),
    )
...
st.write("Graph Neural Networks. Explore and run machine learning demos below.")
